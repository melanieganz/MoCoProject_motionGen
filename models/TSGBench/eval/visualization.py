...
def visualization_tsne(method_name, dataset_name, dataset_state, ax):    
    ...
    # generated_data = np.load('./data/' + method_name + '/sines/' + dataset_name + '_' + dataset_state + '_gen.npz')
    try:
...
# plt.title(dataset_name + '_' + dataset_state + ' generated by ' + method_name)
plt.savefig('./data/' + method_name + '/model_selection/outputs/' + dataset_name + '_' + dataset_state + '_test_tsne.png', dpi=400, bbox_inches='tight')
# plt.savefig('./data/' + method_name + '/grid_search/' + dataset_name + '_' + dataset_state + '_tsne.png', dpi=400, bbox_inches='tight')
# plt.savefig('./data/' + method_name + '/sines/' + dataset_name + '_' + dataset_state + '_tsne.png', dpi=400, bbox_inches='tight')
...
for pos in ['top','right']:
	ax.spines[pos].set_visible(False)
plt.savefig('./data/' + method_name + '/model_selection/outputs/' + dataset_name + '_' + dataset_state + '_test_distr.png', dpi=400, bbox_inches='tight')
# plt.savefig('./data/' + method_name + '/grid_search/' + dataset_name + '_' + dataset_state + '_distr.png', dpi=400, bbox_inches='tight')
# plt.savefig('./data/' + method_name + '/sines/' + dataset_name + '_' + dataset_state + '_distr.png', dpi=400, bbox_inches='tight')
