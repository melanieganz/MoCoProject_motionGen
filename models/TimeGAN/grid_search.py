...
if __name__ == '__main__':  
  # Arguments:
  dataset_name      = "custom_24_sines_6w_correlated_final"
  dataset_state     = "train"
  modules            = ["gru"]
  hidden_dims       = [4 * 24 * 6]
  num_layers        = [3]
  ...
  for module in modules:
    for num_layer in num_layers:
      for hidden_dim in hidden_dims:
        print("\n")
        print("-------------------------------------------------------------------------------------")
        print(f"Training TimeGAN #{flag} with module = {module}, nl = {num_layer}, and hd = {hidden_dims}")
        print("-------------------------------------------------------------------------------------")
        print("\n")
        ...
        # Save the synthethic data to TSGBench for further analysis:
        np.savez_compressed("../TSGBench/data/timegan/sine_experiment/" + sample_fname, data=generated_data)
