...
def visualization_tsne(method_name, dataset_name, dataset_state, ax):    
    ori_data = np.load('./data/' + dataset_name + '_' + dataset_state + '_test.npz')
    ori_data = ori_data['arr_0']
    generated_data = np.load('./data/' + method_name + '/' + dataset_name + '_' + dataset_state + '_gen.npz')
...
print('visualization.py is running')
...
plt.savefig('./figures/' + method_name + '_' + dataset_name + '_' + dataset_state + '_tsne.png', dpi=400, bbox_inches='tight')
...
for pos in ['top','right']:
	ax.spines[pos].set_visible(False)
plt.savefig('./figures/' + method_name + '_' + dataset_name + '_' + dataset_state + '_distr.png', dpi=400, bbox_inches='tight')
