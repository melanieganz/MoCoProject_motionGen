...
def draw_orig_and_post_pred_sample(orig, reconst, n, dataset_name, dataset_state):
    ...
    fig.tight_layout()
    plt.savefig(f'./outputs/{dataset_name}_{dataset_state}_orig_vs_recon.png')
    plt.show()


def plot_samples(samples, n, dataset_name, dataset_state):    
    ...
    fig.tight_layout()
    plt.savefig(f'./outputs/{dataset_name}_{dataset_state}_gen_samples_scaled.png')
    plt.show()


def plot_latent_space_timeseries(vae, n, figsize, dataset_name, dataset_state):
    scale = 3.0
    ...
    fig.tight_layout()
    plt.savefig(f'./outputs/{dataset_name}_{dataset_state}_gen_samples_embedded.png')
    plt.show()
