sine_func_gen.py    generates custom sine waves.
smooth_func_gen.py  generates custom smooth functions.

custom_data_splitting.py    creates train/test split of custom sine waves or custom smooth functions.
